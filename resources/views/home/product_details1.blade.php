...
<body>
    <style>
        ...
        margin: 0;
        padding: 0;
        background: url('artisan/src/images/detail_produit.png') no-repeat center center fixed;
    ...
    <div class="pre-loader">
        <div class="pre-loader-box">
            <div class="loader-logo">
                <img src="artisan/vendors/images/deskapp-logo.svg" alt="" />
            </div>
    ...
    <div class="left-side-bar">
        <div class="brand-logo">
            <a href="index.html">
                <img src="artisan/vendors/images/deskapp-logo.svg" alt="" class="dark-logo" />
                <img src="artisan/vendors/images/deskapp-logo-white.svg" alt="" class="light-logo" />
            </a>
        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li>
                        <a href="https://dropways.github.io/deskapp-free-single-page-website-artisan/"
                            target="_blank" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-layout-text-window-reverse"></span>
                            <span class="mtext">Landing Page
                                <img src="artisan/vendors/images/coming-soon.png" alt=""
                                    width="25" /></span>
                        </a>
                    </li>
                </ul>
                                    ...
                                    <form action="{{ url('/add_cart', $product->id) }}" method="POST"
                                        ...
                                        @csrf
                                            ...
                                            <input type="number" class="quantity-input" name="quantity"
                                                value="1" min="1"style="width: 100px; padding: 5px;"> &nbsp;&nbsp;
                                        &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;
...
$progressWidth = ($average != 0) ? ($oneStarCount / $count) * 100 : 0; @endphp
        ...
        <div class="footer-wrap pd-20 mb-20 card-box">
            DeskApp - Bootstrap 4 Admin artisan By
