...
<body>
    ...
    <div class="comment-section">
        <table>
            <tr>
      <td>  <h2 class="comment">Comments</h2></td>
       <td> <form action="{{url('add_comment')}}" method="POST">
            @csrf
            <textarea id="commentTextarea" name="comment" placeholder="Comment something here ..."></textarea></td>

          <td><input type="submit" class="btn btn-primarye" value="Comment"></td>
        </form>
    </tr>
    </table>
    </div>
